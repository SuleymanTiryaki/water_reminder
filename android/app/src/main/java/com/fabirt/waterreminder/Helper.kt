...
fun Context.setRepeatingWaterAlarm() {
    ...
    kotlinx.coroutines.runBlocking {
        val intervalMinutes = dataStoreProvider.getReminderIntervalMinutes()
        val intervalMillis = intervalMinutes * 60_000L
        
        val intent = Intent(WaterAlarmService.ACTION_START_ALARM_SERVICE, null, this@setRepeatingWaterAlarm, WaterAlarmReceiver::class.java)
        val requestCode = 100867734
        val pendingIntent = PendingIntent.getBroadcast(
            this@setRepeatingWaterAlarm,
            requestCode,
            intent,
            PendingIntent.FLAG_UPDATE_CURRENT or PendingIntent.FLAG_IMMUTABLE
        )

        val alarmManager = ContextCompat.getSystemService(this@setRepeatingWaterAlarm, AlarmManager::class.java)
